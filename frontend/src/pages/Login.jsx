...
import { Eye, EyeOff, AlertCircle, ArrowRight, Lock, Mail, User } from 'lucide-react'
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '40px 48px', position: 'relative', zIndex: 10 }}>
        ...
        >
          ...
          <p style={{ color: '#64748b', marginBottom: '28px', fontSize: '13.5px', lineHeight: 1.5 }}>
            Sign in to continue to your AutoWorkflow workspace.
          </p>
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '13px' }}>
              ...
              <a href="#forgot" onClick={(e) => { e.preventDefault(); toast.info('Password reset instructions sent to your email if registered.'); }} style={{ color: '#4f46e5', textDecoration: 'none', fontWeight: 600 }}>
                Forgot password?
              </a>
            </div>
          ...
          <div style={{ marginTop: '28px', textAlign: 'center', color: '#64748b', fontSize: '13px' }}>
            New to AutoWorkflow? <Link to="/signup" style={{ color: '#4f46e5', textDecoration: 'none', fontWeight: 700 }}>Create an account</Link>
          </div>
        </div>
      </div>
