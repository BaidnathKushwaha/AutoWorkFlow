        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          <input
            ...
            style={{
              ...
              fontSize: '16px', fontWeight: 600, padding: '4px 8px', borderRadius: '4px', outline: 'none',
          ...
          {status === 'running' ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <button
                ...
                disabled
                style={{
                  background: 'var(--accent-amber)', color: '#ffffff', opacity: 0.9, cursor: 'not-allowed',
                  display: 'flex', alignItems: 'center', gap: '6px', boxShadow: '0 0 12px rgba(245, 158, 11, 0.3)',
                }}
              >
