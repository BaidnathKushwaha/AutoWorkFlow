...
public class UserController {
    ...
    public ApiResponse<UserResponse> me() {
        return ApiResponse.success(userService.getCurrentUser(currentUserProvider.getCurrentUserId()));
    }

    @PutMapping("/me")
    public ApiResponse<UserResponse> updateProfile(@Valid @RequestBody UpdateProfileRequest request) {
        return ApiResponse.success(
                userService.updateProfile(currentUserProvider.getCurrentUserId(), request),
    ...
    public ApiResponse<ApiKeyResponse> generateApiKey() {
        return ApiResponse.success(
                userService.generateApiKey(currentUserProvider.getCurrentUserId()),
    ...
    public ApiResponse<ApiKeyResponse> revealApiKey() {
        return ApiResponse.success(userService.revealApiKey(currentUserProvider.getCurrentUserId()));
    }
}
