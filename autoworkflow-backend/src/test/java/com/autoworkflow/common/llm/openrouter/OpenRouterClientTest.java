...
class OpenRouterClientTest {
    ...
    private final AtomicReference<String> capturedAuthHeader =
            new AtomicReference<>();
    ...
    private OpenRouterClient client(
        ...
        OpenRouterClient client =
                new OpenRouterClient(webClient);
    ...
    void successfulChat_returnsContentAndModel() {
        ...
        assertThat(response.content())
                .isEqualTo("Hello from OpenRouter");
    ...
    @Test
    void defaultModelUsed_whenRequestModelIsBlank()
            throws Exception {
    ...
    @Test
    void requestBody_omitsTemperatureAndMaxTokens_whenNotProvided()
            throws Exception {
        ...
        assertThat(
                sentBody.has("temperature")
        ).isFalse();

        assertThat(
                sentBody.has("max_tokens")
        ).isFalse();
        ...
        assertThat(
                sentBody.has("messages")
        ).isTrue();
    }

    @Test
    void requestBody_includesTemperatureAndMaxTokens_whenProvided()
            throws Exception {
        ...
        assertThat(
                sentBody.get("temperature")
                        .asDouble()
        ).isEqualTo(0.3);

        assertThat(
                sentBody.get("max_tokens")
                        .asInt()
        ).isEqualTo(500);
    }
    ...
    void quotaExceeded_mapsToAiProviderExceptionWithCleanMessage() {
        ...
        responseBody =
                "{\"error\":{\"message\":\"Rate limit exceeded, quota exhausted\"}}";
    ...
    @Test
    void requestBody_enforcesJsonObjectResponseFormat()
            throws Exception {
    ...
    @Test
    void requestBody_omitsResponseFormat_whenStructuredOutputIsFalse()
            throws Exception {
    ...
    @Test
    void requestBody_omitsResponseFormat_whenStructuredOutputIsNull()
            throws Exception {
